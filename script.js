...
function respondCountry() {
  ...
  countryResponse.textContent = `Ah! I've always wanted to visit ${country.value}. It's a very beautiful country.`;
...
function respondEnjoy() {
  let enjoyResponse = document.createElement('p');
    ...
    if (enjoy.value === 'yes') {
      ...
      let no = `Well you didn't have to be so rude about it... Whatever then. Suit yourself.`;
      return no;
    };
  }
